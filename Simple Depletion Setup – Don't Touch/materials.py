...
def get_water_density(temp_K):
    # Temperature points in K
    # https://nuclear-power.com/wp-content/uploads/2016/12/Density-of-Water-Specific-Volume-of-Water.png
    T = np.array([
        275 + 273.15,  # 275°C
        300 + 273.15,  # 300°C
        425 + 273.15   # 425°C
    ])
    # Density points in kg/m3 converted to g/cm3
    rho = np.array([
        756.1,  # at 275°C
        713.7,  # at 300°C
        654.0   # at 425°C
    ]) / 1000  # Convert from kg/m3 to g/cm3
    return np.interp(temp_K, T, rho)

def make_materials(mat_list=None):
    # Convert temperatures from Celsius to Kelvin
    T_fuel_K = inputs['T_fuel'] + 273.15
    T_clad_K = inputs['T_clad'] + 273.15
    T_cool_K = inputs['T_cool'] + 273.15
    ...
    if inputs['fuel_type'] == 'UO2':
        ...
        fuel.add_element('U', 1.0, enrichment=inputs['n%'])
    ...
    water.set_density('g/cm3', get_water_density(T_cool_K))
