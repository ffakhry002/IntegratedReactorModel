...
inputs = {
    ...
    # Temperatures
    "T_fuel": 900,                  # Fuel temperature [°C]
    "T_clad": 600,                  # Cladding temperature [°C]
    "T_cool": 310,                  # Coolant temperature [°C]

    ###########################################
    # Depletion Parameters
    ###########################################
    # Power and timesteps
    "power_density": 40.0,          # Power density [W/gHM]
    "depletion_timestep_units": "MWd/kgHM",  # Units for timesteps: 'MWd/kgHM' or 'days'
    "depletion_timesteps": [
        {"steps": 5, "size": 0.1},  # 5 steps of 0.1 MWd/kgHM or days
        {"steps": 5, "size": 1.0},  # 5 steps of 1.0 MWd/kgHM or days
        {"steps": 5, "size": 10},   # 5 steps of 10.0 MWd/kgHM or days
    ],
    ...
    "depletion_integrator": "cecm",  # Integration algorithm (predictor, cecm, celi, cf4, etc.)
}
